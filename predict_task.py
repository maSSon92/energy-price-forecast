...
if __name__ == "__main__":
    ...
    try:
        ...
        pred_df["Actual Fixing I - Kurs"] = pred_df["Hour"].apply(lambda h: actual_prices.get(h, {}).get("fix_i"))
        pred_df["Actual Fixing II - Kurs"] = pred_df["Hour"].apply(lambda h: actual_prices.get(h, {}).get("fix_ii"))
        ...
        for _, row in pred_df.iterrows():
            update_actual_price(date_str, int(row["Hour"]), float(row["Actual Fixing I - Kurs"]))
